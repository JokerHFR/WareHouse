...
public class PurJPanel extends JPanel implements ActionListener,ItemListener{
	...
	private PurJPanelListener jp=null; 
	public PurJPanel(Supplier supplier){
	...
	public void itemStateChanged(ItemEvent e) {
		// TODO Auto-generated method stub
		 if(e.getStateChange() == ItemEvent.SELECTED){
			 ...
			 this.jl2.setText("当前库存："+product.get(i).getQuantity()+"             进货数量：");
			 this.jl3.setText(product.get(i).getProductUnit()+"         进货价格(RMB)：");
		 }
	}
	
	public void addPurJPanelListener(PurJPanelListener jp){
		this.jp=jp;
	}
}
