...
import com.hu.jframe.PurTuiFrame;
...
public class JPanel_7 extends JPanel implements ActionListener,TuiPurJPanelListener,ItemListener{
	 /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	 ...
	 private List<TuiPurJPanel> jp=new ArrayList<TuiPurJPanel>();
...
//	 		this.setResizable(false);//设置不能通过窗体的拖拽，改变窗体的大小
	 		...
	 		this.jl3=new JLabel("   退货地址："+this.supplier.get(0).getSuppliercomAddress());
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.jb1){
			this.size+=1;
			TuiPurJPanel tuipurJPanel=new TuiPurJPanel(this.supplier.get(this.list1.getSelectedIndex()));
			tuipurJPanel.addTuiPurJPanelListener(this);
			jp2.add(tuipurJPanel);
			this.jp.add(tuipurJPanel);
			this.jp2.setPreferredSize(new Dimension(750,size*45));
			jp2.updateUI();
		...
		if(e.getSource()==this.jb2){
		 ...
		 new PurTuiFrame(supplier,l).setVisible(true);
		}
		...
		// TODO Auto-generated method stub
		 if(e.getStateChange() == ItemEvent.SELECTED){
			 ...
			 this.jl3.setText("   进货地址："+this.supplier.get(i).getSuppliercomAddress());
				this.jp2.removeAll();
				this.jp=new ArrayList<TuiPurJPanel>();
				jp2.updateUI();
		 }
	}
	@Override
	public void RemovePanel(TuiPurJPanel tj) {
		// TODO Auto-generated method stub
		this.jp2.remove(tj);
		this.jp.remove(tj);
		jp2.updateUI();
