...
public class DelJPanel extends JPanel implements ActionListener,ItemListener{
	...
	private SupJPanelListener jp=null; 
	public DelJPanel(ProductBL productBL){
		product=productBL.findAllproduct();
	...
	public void itemStateChanged(ItemEvent e) {
		// TODO Auto-generated method stub
		 if(e.getStateChange() == ItemEvent.SELECTED){
			 ...
			 this.jl2.setText("当前库存："+product.get(i).getQuantity()+"             销售数量：");
			 this.jl3.setText(product.get(i).getProductUnit()+"         销售价格(RMB)：");
		 }
	}
	
	public void addSupJPanelListener(SupJPanelListener jp){
		this.jp=jp;
	}
}
