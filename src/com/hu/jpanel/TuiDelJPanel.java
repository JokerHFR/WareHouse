...
public class TuiDelJPanel extends JPanel implements ActionListener,ItemListener{
	...
	private TuiJPanelListener jp=null; 
	public TuiDelJPanel(ProductBL productBL){
	...
	public void addTuiJPanelListener(TuiJPanelListener jp){
		this.jp=jp;
	}
